...
Este repositorio es la fuente de verdad documental del proyecto **Supermercado La Esquina — Sistema de Punto de Venta e Inventario (MVP)**. Todo equipo que trabaje en el proyecto documenta aquí, siguiendo las reglas de gobierno documental.
