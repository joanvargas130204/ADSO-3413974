...
> **Diferencia con `02-domain`:** esta sección describe la implementación de persistencia (tablas, columnas, tipos, relaciones, índices, migraciones). Las entidades de negocio y sus reglas se documentan en [`02-domain/`](../02-domain/). Un mismo concepto (ej: "Producto") tendrá una definición de dominio allá y un esquema de base de datos aquí.
